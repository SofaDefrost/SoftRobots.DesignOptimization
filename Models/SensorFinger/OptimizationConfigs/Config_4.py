...
Compared to optimization problem config 3, the used Poisson ratio and Finger mesh density are set respectively to 0.495 (instead of 0.3) and 3 (instead of 7).
