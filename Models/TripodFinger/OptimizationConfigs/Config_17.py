...
Optimizign the Finger shape for ensuring the best ratio contact force / actuation while having a high contact force.
Same as config 12, but instead we consider only contact forces obtained for an admissible range of the torque.
Also, small distance between object and finger is imposed.
"""
...
class OptimizationConfig(Config):
    ...
    def get_assessed_together_objectives(self):
        return [["IncrementalForceTransmissionX", "ContactForceX"]]
